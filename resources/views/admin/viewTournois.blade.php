...
<body>
    <h1 class="titre">Bienvenue Manager</h1>
    <div class="container">
            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <a href="#addTournamentModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Ajouter Nouveau Tournoi</span></a>
                            <a href="#deleteTournamentModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Supprimer</span></a>
                        </div>
                    </div>
                </div>
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <span class="custom-checkbox">
                                    <input type="checkbox" id="checkbox{{ $tournoi->id }}" name="options[]" value="{{ $tournoi->id }}">
                                    <label for="checkbox{{ $tournoi->id }}"></label>
                                </span>
                            </td>
                            <td>{{ $tournoi->nom }}</td>
                            <td>{{ $tournoi->type }}</td>
                            ...
                            <td>
                                ...
                                <a href="#deleteTournamentModal" class="delete" data-toggle="modal" data-id="{{ $tournoi->id }}"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
